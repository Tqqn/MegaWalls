package dev.tqqn.megawalls.modules.scoreboard.framework;
...
public abstract class PluginScoreboard {
    ...
    public void setScoreboard(PlayerModel playerModel) {
        ...
        MegaWalls.getReflectionLayer().sendSideBarScoreboard(name, playerModel.getPlayer(), displayName, boardLines);
    }
    ...
    public void removeScoreboard() {
        ...
        MegaWalls.getReflectionLayer().removePlayerFromScoreboard(name, playerModel.getPlayer());
    }
    ...
    public void removeScoreboardFromAllPlayers() {
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            MegaWalls.getReflectionLayer().removePlayerFromScoreboard(name, player);
        }
    }
    ...
    public void updateLine(String line, int index) {
        MegaWalls.getReflectionLayer().updateSidebarScoreboardLine(name, playerModel.getPlayer(), line, index);
    }
}
