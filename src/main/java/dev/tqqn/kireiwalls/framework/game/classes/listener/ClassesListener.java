package dev.tqqn.kireiwalls.framework.game.classes.listener;
...
public final class ClassesListener implements Listener {
     ...
     */
    @EventHandler
    public void onPlayerEXPHit(EntityDamageByEntityEvent event) {
        ...
        if (event.getDamager() instanceof Player damager) {
            ...
            damageModel.getCurrentClass().onPlayerHit(damageModel);
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        playerModel.getCurrentClass().onInteract(event);
    }
