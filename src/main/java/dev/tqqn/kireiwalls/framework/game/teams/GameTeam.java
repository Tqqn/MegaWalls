...
public class GameTeam {
    ...
    public GameTeam(String name, String prettyName, String prefix, String color, String legacyColor, NamedTextColor adventureColor, TeamProtectionRegion teamProtectionRegion, Location spawnLocation, Location witherLocation) {
        this.name = name;
